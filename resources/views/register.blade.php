    ...
    <div class="bg-white p-8 rounded shadow-md w-full max-w-md">
        ...
        <form action="/postregister" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="nama_user" name="nama_user" class="w-full p-2 border border-gray-300 rounded mt-1" required>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="no_hp" name="no_hp" class="w-full p-2 border border-gray-300 rounded mt-1" required>
            </div>
            <div class="mb-4">
                <label for="wa" class="block text-gray-700">WhatsApp:</label>
                <input type="text" id="wa" name="wa" class="w-full p-2 border border-gray-300 rounded mt-1" required>
            </div>
            <div class="mb-4">
